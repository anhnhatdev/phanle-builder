...
class DatabaseService {
    ...
    public async initialize(): Promise<void> {
        try {
            ...
            if (!resolvedViaWorkspace) {
                ...
                this.dbPath = path.join(dbFolder, 'phanle-tool.db');
            }
    ...
    /**
     * Reinitialize DatabaseService từ path mới (đọc lại phanle-config.json).
     ...
     *
     * Example:
     *   baseDir = "C:\Users\Admin\AppData\Roaming\phanle\media"
