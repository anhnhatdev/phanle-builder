...
const FEATURES: Feature[] = [
  ...
  { id: 'donate',       icon: '☕', label: 'Donate & Ủng hộ' },
];
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h3 className="text-white font-bold text-base">phanle</h3>
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          phanle cho phép bạn đăng nhập và quản lý <strong className="text-white font-semibold">không giới hạn tài khoản Zalo và Facebook</strong> trong một giao diện duy nhất.
      ...
      <Card>
        ...
        <Paragraph>
          phanle hỗ trợ cấu hình proxy trước khi đăng nhập tài khoản Zalo. Hữu ích khi cần tách biệt IP cho từng tài khoản,
        ...
        <div className="flex items-start gap-3 bg-yellow-900/20 border border-yellow-700/40 rounded-lg px-3 py-2.5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              phanle tập trung vào nhắn tin và Tự động hoá. Các cuộc gọi thoại và video call qua Zalo
...
function ErpPanel() {
  return (
    <div className="space-y-4">
      <Card>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <Paragraph>
              Module ERP giúp đội nhóm quản lý công việc nội bộ ngay trong phanle: từ giao task, theo dõi deadline,
      ...
      <Card>
        <SectionTitle>💡 Khi nào nên dùng ERP trong phanle?</SectionTitle>
        <BulletList items={[
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Kết nối phanle với phần mềm quản lý bán hàng (POS) cho phép tra cứu đơn hàng, khách hàng, sản phẩm
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Kết nối phanle với các cổng thanh toán để nhận thông báo ngay khi có giao dịch chuyển khoản vào tài khoản ngân hàng.
      ...
      <Card>
        ...
        <Paragraph>
          phanle chạy webhook server trên máy tính cá nhân (cục bộ). Để Casso/SePay có thể gửi webhook đến máy bạn,
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Kết nối phanle với các đơn vị vận chuyển để tạo đơn giao hàng, tra cứu trạng thái vận đơn
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Trợ lý AI trong phanle cho phép bạn tạo nhiều chatbot AI với tính cách, prompt và mục đích khác nhau.
      ...
      <div className="border-t border-gray-700/50 pt-4">
        ...
        <Card>
          <SectionTitle>🎯 Tại sao dùng 9Router với phanle?</SectionTitle>
          <BulletList items={[
        ...
        <Card>
          ...
          <StepList steps={[
            ...
            { title: 'Dùng trong phanle', desc: 'Vào <strong class="text-gray-200">Cài đặt → Giới thiệu → Trợ lý AI</strong> hoặc <strong class="text-gray-200">Tích hợp → Trợ lý AI</strong>, chọn nền tảng <strong class="text-gray-200">9Router</strong> và chọn model miễn phí.' },
          ]} />
        </Card>
        ...
        <Card>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-900/40 border border-gray-700/60 rounded-xl p-3.5 flex items-start gap-3.5 hover:border-blue-700/50 transition-colors group">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-gray-200 text-xs font-semibold">Cấu hình trong phanle</span>
        ...
        <Card>
          <SectionTitle>🔧 Cấu hình trong phanle</SectionTitle>
          <Paragraph>
            Sau khi đã cài đặt và chạy 9Router, cấu hình phanle để sử dụng 9Router làm proxy AI:
          </Paragraph>
        ...
        <Card>
          ...
          <BulletList items={[
            '<strong class="text-gray-200">9Router phải chạy cùng lúc với phanle</strong> — nếu tắt 9Router, AI request qua 9Router sẽ thất bại',
            ...
            '<strong class="text-gray-200">Kiểm tra kết nối:</strong> Sau khi cấu hình, dùng thử AI Assistant trong phanle để xác nhận hoạt động',
          ]} />
        </Card>
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          phanle được xây dựng theo kiến trúc toàn bộ dữ liệu được xử lý và lưu trữ ngay trên máy tính của bạn.
        </Paragraph>
        <BulletList items={[
        ...
        <div className="flex items-start gap-3 bg-yellow-900/20 border border-yellow-700/40 rounded-lg px-3 py-3 mb-2">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              ...
              <code style={{color:'#86efac',background:'#1f2937',padding:'0.0625rem 0.375rem',borderRadius:'0.25rem',margin:'0 0.1875rem'}}>C:\Users\...\AppData\Roaming\phanle</code>.
      ...
      <Card>
        ...
        <Paragraph>
          Mặc định, dữ liệu được lưu tại thư mục <code style={{color:'#86efac',background:'#1f2937',padding:'0.0625rem 0.375rem',borderRadius:'0.25rem'}}>%AppData%\phanle</code> trên Windows (ổ C).
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <Paragraph>
          phanle hỗ trợ mô hình <strong>1 Boss — nhiều nhân viên</strong>: Boss chạy app trên máy chủ, bật Relay Server,
      ...
      <Card>
        ...
        <StepList steps={[
          ...
          { title: 'Nhân viên cài app', desc: 'Nhân viên cài phanle trên máy của họ, nhập địa chỉ LAN (IP:cổng) hoặc URL WAN từ boss.' },
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <Paragraph>
          phanle là phần mềm hỗ trợ quản lý giao tiếp trên nền tảng Zalo dành cho mục đích
      ...
      <Card>
        ...
        <BulletList items={[
          ...
          '<strong class="text-gray-200">Không chia sẻ với bên thứ 3</strong>: phanle không tích hợp bất kỳ SDK thu thập dữ liệu, analytics hay quảng cáo của bên thứ 3.',
      ...
      <Card>
        ...
        <BulletList items={[
          'phanle là công cụ hỗ trợ. Người dùng <strong class="text-gray-200">hoàn toàn chịu trách nhiệm</strong> về cách sử dụng phần mềm và tuân thủ pháp luật hiện hành.',
      ...
      <Card>
        ...
        <Paragraph>
          phanle và tất cả tài liệu liên quan là tài sản trí tuệ của <strong className="text-white font-semibold">phanle Team</strong>.
    ...
    <div className="space-y-4">
        ...
        <StepList steps={[
          {
            ...
            desc: 'Lặp lại thao tác khi gặp lỗi. Ghi nhận từng bước cụ thể (VD: "Mở CRM → Nhấn Chiến dịch → Nhấn Tạo mới → Lỗi"). Xác nhận lỗi xảy ra mỗi lần hay chỉ thỉnh thoảng. Thử trên phiên bản phanle mới nhất.',
          },
          {
          ...
          },
          {
            ...
            desc: 'Phiên bản phanle (thanh trên cùng bên trái). Hệ điều hành (Windows 10/11, macOS Intel/Apple Silicon). Tài khoản nào gặp lỗi (Zalo cá nhân, Business, Facebook). Tính năng liên quan. Nếu có lỗi Console (Ctrl+Shift+I → Console) — copy-paste nội dung.',
          },
          {
          ...
          },
          {
            ...
            desc: 'Nhấn Submit trên GitHub. Theo dõi email thông báo khi có phản hồi. Phản hồi sớm khi nhóm yêu cầu thêm thông tin. Khi lỗi đã sửa, cập nhật phanle và xác nhận lại.',
          },
        ]} />
      </Card>
      ...
      <Card>
        ...
        <div className="bg-gray-900/60 rounded-lg border border-gray-700/50 p-3 space-y-2 text-xs">
          ...
          <p className="text-gray-400 leading-relaxed">
            <strong className="text-gray-200">Môi trường:</strong> phanle v26.4.5, Windows 11, Zalo cá nhân.
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-gray-400 text-xs mt-0.5 leading-relaxed">
            Dự án phát triển bởi <strong className="text-gray-200">phanle</strong> với mục tiêu mang công cụ all-in-one tất cả mọi thứ người dùng cần để quản lý và marketing
      ...
      <Card>
        ...
        <Paragraph>
          Ngoài phanle, team còn nhận phát triển phần mềm theo yêu cầu riêng (custom software development).
          Nếu bạn cần một công cụ quản lý, tự động hoá hoặc bất cứ giải pháp công nghệ nào, đừng ngần ngại liên hệ!
        </Paragraph>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1">
          {[
            { icon: '🛠️', title: 'Phần mềm desktop', desc: 'Ứng dụng Electron, React, TypeScript cho Windows/macOS' },
            { icon: '🌐', title: 'Web app & API', desc: 'Backend Node.js, React, PHP,... database quản lý doanh nghiệp' },
            { icon: '🤖', title: 'Tự động hoá & Bot', desc: 'Zalo bot, Facebook bot, Telegram bot, workflow automation' },
            { icon: '📊', title: 'CRM & ERP', desc: 'Hệ thống quản lý khách hàng, nhân viên, bán hàng riêng' },
            { icon: '🔌', title: 'Tích hợp API', desc: 'Kết nối POS, thanh toán, vận chuyển, webhook, third-party' },
            { icon: '📱', title: 'AI & Chatbot', desc: 'Tích hợp GPT, Gemini, xử lý ngôn ngữ tự nhiên, phân loại' },
          ].map((item, i) => (
            <div key={i} className="bg-gray-700/30 rounded-lg p-2.5 border border-gray-600/30">
              <div className="flex items-center gap-1.5 mb-1">
                <span className="text-sm">{item.icon}</span>
      ...
      {/* Contact */}
      <Card>
        <SectionTitle>📞 Liên hệ team</SectionTitle>
        <div className="space-y-2">
          <div className="flex items-center gap-2.5 bg-gray-700/40 rounded-lg px-3 py-2.5">
          ...
          <div className="bg-gradient-to-r from-amber-900/20 to-orange-900/20 border border-amber-600/30 rounded-lg p-3">
            <p className="text-xs text-amber-300 font-medium text-center">
              ☕ Cảm ơn bạn đã quan tâm và ủng hộ! Mỗi đóng góp đều giúp dự án phát triển tốt hơn.
            </p>
          </div>
        </div>
      </Card>
